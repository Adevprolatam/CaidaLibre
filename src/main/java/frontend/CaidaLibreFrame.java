 ...
 * @author dell
 */
public class CaidaLibreFrame extends javax.swing.JFrame {

    /**
     * Creates new form CaidaLibreFrame
     */
    ...
    private void initComponents() {
        ...
        jButtonCalcular.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jButtonCalcular.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        jButtonCalcular.setPreferredSize(new java.awt.Dimension(33, 20));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CaidaLibreFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CaidaLibreFrame().setVisible(true);
            }
        });
    }
